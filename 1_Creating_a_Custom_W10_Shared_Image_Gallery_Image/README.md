...
Clean Up
Note!!! Note! If you want to now try and take this SIG image, and re-customize it, try quick quickstart 2_Creating_a_Custom_Win_Shared_Image_Gallery_Image_from_SIG, and do not run the following code!!!!!
